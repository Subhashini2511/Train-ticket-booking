...
if(bookingarr.age >=60) {
    ...
    if(LowerAllocation < lower.length){
        ...
        lower[LowerAllocation].style.backgroundColor = 'greenyellow';
    ...
    if (MiddleAllocation<middle.length){
        ...
        middle[MiddleAllocation].style.backgroundColor = 'greenyellow';
    ...
    if (UpperAllocation<upper.length){
        ...
        upper[UpperAllocation].style.backgroundColor = 'greenyellow';
